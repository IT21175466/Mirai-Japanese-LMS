...
class SingleQuestionPastPaper extends StatefulWidget {
  ...
  @override
  State<SingleQuestionPastPaper> createState() =>
      _SingleQuestionPastPaperState();
}

class _SingleQuestionPastPaperState extends State<SingleQuestionPastPaper> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Do you want to exit from the lesson?',
                          style: TextStyle(
                            fontFamily: 'Poppins',
