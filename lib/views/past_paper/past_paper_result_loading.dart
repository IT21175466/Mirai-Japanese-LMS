...
import 'package:miraijapanese/views/past_paper/past_paper_result_screen.dart';
import 'package:provider/provider.dart';

class ResultLoadingPastPaper extends StatefulWidget {
  final int corrects;
  final int wrongs;
  final int quesionAmount;
  const ResultLoadingPastPaper(
      {super.key,
  ...
  @override
  State<ResultLoadingPastPaper> createState() => _ResultLoadingPastPaperState();
}

class _ResultLoadingPastPaperState extends State<ResultLoadingPastPaper> {
  double score = 0.0;
  @override
  void initState() {
    super.initState();
    ...
    appDataProvider.getData().then((value) => {
          Timer(
            ...
            () => Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => PastPaperResultScreen(
