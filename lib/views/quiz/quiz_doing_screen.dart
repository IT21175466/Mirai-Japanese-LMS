...
import 'package:miraijapanese/views/quiz/result_loading_screen.dart';
...
class QuizDoingScreen extends StatefulWidget {
  ...
  const QuizDoingScreen({super.key, required this.quizName});
                        ...
                        ? GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ResultsLoadingScreen(
